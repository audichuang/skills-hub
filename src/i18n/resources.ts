export const resources = {
  en: {
    translation: {
      ...
      batchUpdate: 'Update',
      batchDelete: 'Delete',
      batchDeleteConfirm: 'Are you sure you want to delete {{count}} skills? This will remove them from all tools and delete their local copies.',
      toolsLabel: 'Tools',
      ...
      appUpdate: {
        ...
        ready: 'Update Ready',
        restartPrompt: 'Restart to apply the update.',
        btnRestart: 'Restart Now',
        btnLater: 'Later',
        failed: 'Update failed',
        retry: 'Retry',
      },
      latestVersion: "You're up to date!",
      newVersionAvailable: 'New version: v{{version}}',
      brewUpgrade: 'Brew Upgrade',
      brewUpgrading: 'Upgrading...',
      brewSuccess: 'Upgrade successful! Restarting...',
    },
  },
  'zh-CN': {
    translation: {
      ...
      skillsEmpty: '暂无托管记录。',
      skillGroupCount: '{{count}} 个 Skill',
      batchEdit: '编辑',
      batchSelectAll: '全选',
      batchSelectedCount: '已选 {{count}} 个',
      batchUpdate: '更新',
      batchDelete: '删除',
      batchDeleteConfirm: '确定要删除这 {{count}} 个 Skill 吗？这将从所有工具中移除并删除本地副本。',
      toolsLabel: '工具',
      activeTools: '活跃工具',
      sourceLabel: '来源',
      pathLabel: '路径',
  ...
  'zh-TW': {
    translation: {
      ...
      skillsEmpty: '尚無託管紀錄。',
      skillGroupCount: '{{count}} 個 Skill',
      batchEdit: '編輯',
      batchSelectAll: '全選',
      batchSelectedCount: '已選 {{count}} 個',
      batchUpdate: '更新',
      batchDelete: '刪除',
      batchDeleteConfirm: '確定要刪除這 {{count}} 個 Skill 嗎？這將從所有工具中移除並刪除本地副本。',
      toolsLabel: '工具',
      activeTools: '使用中工具',
      sourceLabel: '來源',
      pathLabel: '路徑',
      ...
      latestVersion: '已是最新版本！',
      newVersionAvailable: '發現新版本：v{{version}}',
      brewUpgrade: 'Brew 升級',
      brewUpgrading: '升級中...',
      brewSuccess: '升級成功！正在重啟...',
    },
  },
} as const
